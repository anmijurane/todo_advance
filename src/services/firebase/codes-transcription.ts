...
interface CodesFirebase {
  [key: string]: string
}

export const getTranscriptionFirebaseCode = ({ code }: FirebaseError) =>
  CODES_FIREBASE[code] || `[unknown code]: ${code}`;

const CODES_FIREBASE:CodesFirebase = {
  ...
  'auth/popup-closed-by-user': 'Se cancelo en inicio de sesión, debes iniciar sesión en la ventana emergente.',
};
